 ...
 */
public class TestItemItemScorer extends AbstractItemScorer implements ItemScorer {
    private static final Logger logger = LoggerFactory.getLogger(TestItemItemScorer.class);
     ...
     */
    @Inject
    public TestItemItemScorer(UserEventDAO dao, ItemItemModel m,
