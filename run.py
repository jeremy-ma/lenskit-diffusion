...
similarity_matrix_funcs = ['adjusted_cosine', 'pearson', 'cosine']
...
if __name__ == '__main__':
    ...
    for i in xrange(5):
        helper.main_double_diffusion(input_file='ml-100k/u.data-crossfold/train.' + str(i) + '.csv', sim_func='adjusted_cosine',
                    alpha_nL=1.0, threshold_fraction=0.08, transform=helper.transformation_linear, output_prefix=str(i) + '_')
